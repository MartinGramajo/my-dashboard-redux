...
// function para generar la generación estática
// Tenemos que retornar nuestros params: un arreglo con todos los params que quiero que sean en construccion
// snippet: GSP
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    return {
      ...
      description: "La página que buscas no se encuentra"
    }
  }
